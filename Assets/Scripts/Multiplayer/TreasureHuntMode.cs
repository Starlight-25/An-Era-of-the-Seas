...
public class TreasureHuntMode : NetworkBehaviour
{
    ...
    public void SpawnChest() 
    {
        ...
        GameObject chestInstance = Instantiate(ChestPrefab, position, Quaternion.identity);
        chestInstance.GetComponent<NetworkObject>().Spawn();
        Debug.Log(position);
    }
}
