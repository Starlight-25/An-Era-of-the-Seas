...
public class SellManager : MonoBehaviour
{
    ...
    [SerializeField] private ItemSellDescription ItemSellDescription;
    ...
    private void AddItem(Item item)
    {
        ...
        newItem.GetComponent<Button>().onClick.AddListener(() => ItemSellDescription.SetDescriptionItem(item));
    }
    ...
    private void AddMaterial(Material material)
    {
        ...
        newItem.GetComponent<Button>().onClick.AddListener(() => ItemSellDescription.SetDescriptionMaterial(material));
    }
