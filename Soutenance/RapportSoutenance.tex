...
\newpage
\subsection{Achref}
\subsubsection{Website Development}\hfill

The website creation project officially began on October 31st, setting the stage for an ambitious and meticulous journey. The initial task involved designing the general structure of the site. This crucial step aimed to outline a coherent framework and identify the essential web pages needed to meet the project's goals. It was during this phase that the blueprint for the website began to take shape, establishing a clear vision of its layout and purpose.\\

Just a few days later, on November 5th, a market study was conducted to analyze the practices and approaches of various video game development companies. This research aimed to provide inspiration and ensure that the project aligned with industry standards and user expectations.\\

Simultaneously, technical development commenced with the writing of the core code in HTML and CSS. This stage brought the website to life by defining its visual and structural elements. The hands-on work of coding provided a tangible sense of progress and accomplishment for the project team, as the abstract concepts and designs began to materialize.\\

On November 9th, the focus shifted to the critical task of planning the website's deployment strategy. The person in charge undertook a thorough reflection on the optimal methods for deploying and managing the site. This process uncovered areas that required reconfiguration and led to the decision to adopt Odoo, an advanced platform known for its robust integration and management capabilities.\\

However, this shift in strategy brought unexpected challenges. The adoption of Odoo necessitated a complete reset of several configurations and even required the person in charge to restart the work from scratch. This development was a significant setback and caused considerable frustration, as much of the progress had to be redone. Despite the hurdles, the decision to pivot to Odoo promised long-term benefits, providing enhanced scalability and efficiency for the project.\\

By November 11th, the project reached its final phase. During this stage, all remaining elements—graphic design, technical features, and functional components—were carefully refined and completed. This comprehensive effort ensured that the website not only met the initial requirements but also offered a polished, professional user experience.\\

Finally, on November 15th, the website was officially deployed. This milestone marked the culmination of weeks of dedicated effort, overcoming technical challenges, and refining every aspect of the project. The successful deployment represented a major achievement, signaling the completion of the website creation phase and paving the way for the next stages of the broader project.



\subsubsection{Artificial Intelligence}\hfill

On January 1st, a detailed reflection was carried out to determine the various artificial intelligences (AI) to be implemented in the project, along with their specific behaviors. This phase included extensive online research to gather resources and inspiration, ensuring the coding of these behaviors would be both effective and innovative.\\

Following several days of design and programming, significant progress was made. By January 11th, the development of enemy AIs for scenarios involving movement and interaction on solid ground was successfully completed, marking an important milestone in the project.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Smuggler's Blunderbuss
            \end{itemize}
            \item Rare
            \begin{itemize}
                \item Mariner's Revolver
                \item Corsair's Flintlock
            \end{itemize}
            \item Epic
            \begin{itemize}
                \item Tempest Pistol
                \item Vortex Cannon
                \item Ghost Ship Musket
                \item Comet's Fury
            \end{itemize}
            \item Legendary
            \begin{itemize}
                \item Hellfire Revolver
                \item Heavenly Shard
            \end{itemize}
        \end{itemize}
    \end{itemize}
...
\includegraphics[width=5in]{annex/Map.png}
...
\subsubsection*{UI}
\includegraphics[width=6in]{annex/UI.png}
...
\includegraphics[width=6in]{annex/BoatMovement.png}
