...
\begin{center}
    \includegraphics[width=5in]{Illustration/MainMenu.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5in]{Illustration/PlayerUI.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5in]{Illustration/Inventory.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5in]{Illustration/UpgradeMenu.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5in]{Illustration/EquipmentMenu.png}
    \includegraphics[width=5in]{Illustration/EquipmentMenu2.png}
\end{center}
...
\begin{center}
    \includegraphics[width=5in]{Illustration/Rain.png}
\end{center}
...
A dedicated script was developed to load player data from the JSON file and convert it into usable C\# objects. This script recalculated player statistics dynamically based on equipped weapons and stigmata, integrating seamlessly with the earlier systems for game object data loading.
