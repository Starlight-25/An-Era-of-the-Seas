...
\begin{table}[h]
    ...
    \begin{tabular}{|>{\columncolor{pastelblue!60}}l|c|c|}
        \hline
        \rowcolor{pastelblue!60}
        \textbf{Tasks} & \textbf{Current progress} & textbf{Planned progress}\\
        \hline
        Menu \& UI & 100 & 100\\
        \hline
...
The last step of the project is to reunite all the last functionalities together to create the final product, \textit{An Era of the Seas}, and build the executable.
